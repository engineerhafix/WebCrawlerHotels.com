// this code is working it grabs data from the particular website and populates Name, Urls, price, images but in a seperate arrays
...
//*********************************************************************** */
    ...
    const titles = await page.evaluate(() => 
        Array.from(document.querySelectorAll('.uitk-spacing-margin-blockstart-three div > h2'))
            .map((name)=>name.textContent.trim().split('\n').shift()));
